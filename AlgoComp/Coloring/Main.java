...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // New Graph 2: A complete graph (every node is connected to every other node)
        System.out.println("\nGraph 2:");
        boolean[][] graph2 = {
                { false, true, true, true },
        ...
        graphColoring(graph2, 4); // Testing with 4 colors

        // New Graph 3: A cycle graph (each node is connected in a cycle)
        System.out.println("\nGraph 3:");
        boolean[][] graph3 = {
        ...
        graphColoring(graph3, 2); // Testing with 2 colors
    }
}
